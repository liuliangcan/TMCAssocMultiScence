...
LDLIBSOPTIONS=-lpthread lib/libTransformCsvInterFace.so

# Build Targets
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/tmcassocmultiscence

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/tmcassocmultiscence: lib/libTransformCsvInterFace.so
...
${OBJECTDIR}/Assoc.o: Assoc.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Assoc.o Assoc.cpp

${OBJECTDIR}/BinFilesReader.o: BinFilesReader.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/BinFilesReader.o BinFilesReader.cpp

${OBJECTDIR}/FilesMemoryManager.o: FilesMemoryManager.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/FilesMemoryManager.o FilesMemoryManager.cpp

${OBJECTDIR}/GlobalConfiger.o: GlobalConfiger.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/GlobalConfiger.o GlobalConfiger.cpp

${OBJECTDIR}/ThreadManager.o: ThreadManager.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ThreadManager.o ThreadManager.cpp
...
${OBJECTDIR}/tools/Markup.o: tools/Markup.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/tools/Markup.o tools/Markup.cpp
...
${OBJECTDIR}/tools/log.o: tools/log.cpp 
	${MKDIR} -p ${OBJECTDIR}/tools
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/tools/log.o tools/log.cpp

${OBJECTDIR}/tools/macro.o: tools/macro.cpp 
	${MKDIR} -p ${OBJECTDIR}/tools
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/tools/macro.o tools/macro.cpp
